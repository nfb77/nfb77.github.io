...
<div class="spacer"></div>
    ...
    <p>In a forthcoming article with Karim Nchare in the Journal of Housing Economics, we explored the connection between upzoning, displacement, and housing affordability in Nashville. Taking advantage of quasi-experimental policy design, we estimate heterogeneous market segment <a href="https://nfb77.github.io/Files/URTPN.pdf" target="_blank">effects of upzoning on housing prices in Nashville</a>, showing decreases in affordability concentrated bottom quartile of sales simultaneously with potential price mitigation concentrated in the top fourth of the housing price distribution./>
    
    <p> In another strand of research, I analyzed trade relationships between Portugal and its former African colonies from 1960–2022, providing <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4874987" target="_blank">quantitative evidence for the persistence of colonial commodity dependence</a> and natural resource exploitation.</p><img width="468" height="162" alt="image" src="https://github.com/user-attachments/assets/398a7788-27d8-40df-a606-b710b773d02c" />
