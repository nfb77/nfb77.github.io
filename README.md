<div style="display: flex; align-items: flex-start;">
    ...
    <img src="nashville_map.jpg" alt="Nashville Map" style="height: 300px; margin-right: 20px;">
    <img src="art1.jpg" alt="Artwork" style="height: 300px; margin-right: 0px;">
</div>
...
<div style="display: flex; align-items: flex-start;">
    <img src="r_park2.png" alt="Resivoir" style="height: 245px; margin-right: 20px;">
    <img src="art6.jpg" alt="Artwork" style="height: 245px; margin-right: 20px;">
</div>
