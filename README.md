...
.navbar a:hover {
  ...
  border-radius: 5px;
    ...
    h1, h2 {
      scroll-margin-top: 50px; /* or whatever height your navbar is + some padding */
      margin: 100px 0 20px;
      color: #2c3e50;
    }
...
<body>
  ...
  <div class="wrapper">
<img src="nashville_map.jpg" alt="Nashville Map" style="max-width: 85%; height: auto; display: block; margin: 0 auto;">
